    terraform {
      backend "http" {
        address        = "http://localhost:8081/state/codeforge_infra"
        lock_address   = "http://localhost:8081/state/codeforge_infra"
        unlock_address = "http://localhost:8081/state/codeforge_infra"
        lock_method    = "LOCK"
